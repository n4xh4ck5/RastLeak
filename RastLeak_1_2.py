...
def SendRequest(dork):
	...
	try:
		#Requests
		#Timeout to verify if the resoruce is available and verify to ignore SSL certificate
...
####### FUNCTION DOWNLOADFILES ######
def Display_Export_Metadata(data):
	try:
		#print data
		print "-----------------------------------------------"
		...
		print "\n################################################\n"
		print "-----------------------------------------------"
		#Export Results of summary in json
		with open("metadata.json", 'w') as f:
			print "Results exported such as metadata.json"
			json.dump(data, f)
